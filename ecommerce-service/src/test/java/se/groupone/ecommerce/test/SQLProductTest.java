...
public class SQLProductTest
{
	...
	@Test
	public void a_addProducts() throws RepositoryException
	{
	...
	@Test
	public void b_getProduct() throws RepositoryException
	{
		SQLProduct sqlp = new SQLProduct();
	...
	@Test
	public void c_getProducts() throws RepositoryException
	{
		SQLProduct sqlp = new SQLProduct();
	...
	@Test
	public void c_updateProduct() throws RepositoryException
	{
		SQLProduct sqlp = new SQLProduct();
	...
	@Test
	public void d_removeProduct() throws RepositoryException
	{
		SQLProduct sqlp = new SQLProduct();
	...
	public void e_getProductThatDoesNotExist() throws RepositoryException
	{
		SQLProduct sqlp = new SQLProduct();
	...
	@Test
	public void f_getMAXID() throws RepositoryException
	{
		SQLProduct sqlp = new SQLProduct();
		sqlp.addProduct(p1);
		sqlp.addProduct(p2);
	...
	@Test
	public void g_productQuantityChange() throws RepositoryException
	{
		SQLProduct sqlp = new SQLProduct();
	...
	@Test(expected=Exception.class)
	public void h_cleanIp() throws RepositoryException
	{
		SQLProduct sqlp = new SQLProduct();
		sqlp.removeProduct(p1.getId());
		sqlp.removeProduct(p2.getId());
