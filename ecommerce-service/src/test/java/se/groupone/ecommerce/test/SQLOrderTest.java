...
//	
//	@Test
//	public void e_updateOrder() throws RepositoryException
//	{
//		SQLOrder sqlo = new SQLOrder();
//		Order orderT = new Order(order.getId(), order.getUsername(), order.getProductIds());
//		assertEquals(orderT, order);
//		assertEquals(orderT, sqlo.getOrder(orderT.getId()));
//		orderT.shipIt();
//		assertNotEquals(orderT, order);
//		assertNotEquals(orderT, sqlo.getOrder(orderT.getId()));
//		sqlo.updateOrder(orderT);
//		assertEquals(orderT, sqlo.getOrder(orderT.getId()));
//		order2.shipIt();
//		assertNotEquals(order2, sqlo.getOrder(order2.getId()));
//		sqlo.updateOrder(order2);
//		assertEquals(order2, sqlo.getOrder(order2.getId()));
//	}
//	
//	@Test
//	public void f_removeOrder() throws RepositoryException
//	{
//		SQLOrder sqlo = new SQLOrder();
//		sqlo.removeOrder(1);
//		sqlo.removeOrder(2);
...
//	public void g_getOrderThatDoesNotExist() throws RepositoryException
//	{
//		SQLOrder sqlo = new SQLOrder();
//		sqlo.getOrder(2);
//	}
