...
//public final class ListOfProductMapper implements MessageBodyWriter<List<Product>>
//{
//	private Gson gson;
//
//	public ListOfProductMapper()
//	{
//		gson = new GsonBuilder().registerTypeAdapter(List<Product>.class, new ProductAdapter()).create();
//	}
//
//	// MessageBodyWriter
//	@Override
